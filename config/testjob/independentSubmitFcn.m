...
for ii = 1:numberOfTasks
    ...
    additionalSubmitArgs = '-N testjob -l walltime=00:30:00 -j oe -m cmiller@osc.edu 8gb';    % Create a script to submit a PBS job - this will be created in the job directory
